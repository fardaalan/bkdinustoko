                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="<?= base_url('public/fashi-master/uploads/'.$barang->gambar.'') ?>" alt="">
                                <div class="zoom-icon">
                            ...
                            <div class="product-thumbs">
                                <div class="product-thumbs-track ps-slider owl-carousel">
                                    <div class="pt active" data-imgbigurl="<?= base_url('public/fashi-master/uploads/'.$barang->gambar.'') ?>"><img
                                            src="<?= base_url('public/fashi-master/uploads/'.$barang->gambar.'') ?>" alt=""></div>
                                    <div class="pt" data-imgbigurl="<?= base_url('public/fashi-master/uploads/'.$barang->gambar.'') ?>"><img
                                            src="<?= base_url('public/fashi-master/uploads/'.$barang->gambar.'') ?>" alt=""></div>
                                    <div class="pt" data-imgbigurl="<?= base_url('public/fashi-master/uploads/'.$barang->gambar.'') ?>"><img
                                            src="<?= base_url('public/fashi-master/uploads/'.$barang->gambar.'') ?>" alt=""></div>
                                    <div class="pt" data-imgbigurl="<?= base_url('public/fashi-master/uploads/'.$barang->gambar.'') ?>"><img
                            ...
                            <div class="product-details">
                                ...
                                <div class="pd-desc"> 
                                    ...
                                    <?= form_open('buy') ?>
                                        ...
                                        <button type="button" class="cekvoucher btn btn-md btn-primary" id="cekvoucher">Cek Voucher</button>
	...
	$('document').ready(function(){
        ...
        $('#cekvoucher').on('click', function(){
            ...
            $.ajax({
				...
				success : function(data){
                    datavoc = JSON.parse(data);
					console.log(datavoc.msg);
                    if(datavoc.status == 'success'){
                        var totalharga_awal = $('#total_harga').val();
                        var totalharga = totalharga_awal;
                        totalharga = totalharga * datavoc.nominal / 100;
                        totalharga_akhir = totalharga_awal - totalharga;
                        $('#total_harga').val(totalharga_akhir);
                        $('#cekvoucher').prop('disabled', true);
                    }
                    Swal.fire({
                        icon: datavoc.status,
                        title: 'Error',
